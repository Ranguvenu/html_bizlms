...
final class permission_test extends \advanced_testcase {
    ...
    public function test_can_view(): void {
        ...
        $this->getDataGenerator()->enrol_user($user->id, $course4->id, 'employee');
    ...
    public function test_can_rate(): void {
        ...
        $this->getDataGenerator()->enrol_user($user1->id, $course->id, 'employee');
        $user3 = $this->getDataGenerator()->create_user();
        $this->getDataGenerator()->enrol_user($user3->id, $course->id, 'teacher');

        // Only user who is enrolled as a employee can add rating.
        $this->setUser($user1);
    ...
    public function test_can_rate_completion(): void {
        ...
        $user2 = $this->getDataGenerator()->create_user();
        $this->getDataGenerator()->enrol_user($user1->id, $course->id, 'employee');
        $this->getDataGenerator()->enrol_user($user2->id, $course->id, 'employee');
