...
class tool_courserating_generator extends testing_module_generator {
     ...
     * @param int $mode
     */
    public function set_course_rating_mode(int $componentid, int $mode) {
        if ($data = helper::get_course_rating_enabled_data_in_cfield($componentid)) {
     ...
     * @return rating
     */
    public function create_rating(int $userid, int $componentid, int $rating, string $review = '') {
        ...
        return api::set_rating($componentid, $formdata, $userid);
    }
}
