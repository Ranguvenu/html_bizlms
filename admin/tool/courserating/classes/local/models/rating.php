...
class rating extends \core\persistent {
   ...
   /* public function get_context(): \context_course {
        switch($this->get('component')) {
            case 'local_courses':
            $categorycontext = \context_course::instance($this->get('componentid'));
                break;
           case "local_program":
                $categorycontext = (new \local_program\lib\accesslib())::get_module_context($this->get('componentid'));
            break;
            case "local_learningplan":
                $categorycontext = (new \local_learningplan\lib\accesslib())::get_module_context($this->get('componentid'));
            break;
              case "local_classroom":
                $categorycontext = (new \local_classroom\lib\accesslib())::get_module_context($this->get('componentid'));
            break;
        }
        // if($this->get('component') == "local_courses"){
        //     echo "sds";
        //     exit;
