...
class course_ratings_report extends system_report {
    ...
    protected function initialise(): void {
        ...
        $paramcomponentid = database::generate_param_name();
        $this->add_base_condition_sql("{$ratingtablealias}.componentid = :{$paramcomponentid}",
            [$paramcomponentid => $this->get_course_id()]);
