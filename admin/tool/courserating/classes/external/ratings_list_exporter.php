...
class ratings_list_exporter extends exporter {
    ...
    public function __construct($related) {
        ...
        $this->cmpname = $related['component'];
    ...
    protected function get_other_values(renderer_base $output) {
        $componentid = $this->related['componentid'];
        $component = $this->cmpname;
        ...
        $reviews = rating::get_records_select(
            'componentid = :componentid AND component LIKE :component'.
            (empty($this->related['showempty']) ? ' AND hasreview = 1' : '').
            ($withrating ? ' AND rating = :rating' : ''),
            ['componentid' => $componentid,'component'=> $component, 'rating' => $withrating],
