...
class course_rating_popup extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'componentid' => new external_value(PARAM_INT, 'Course id'),
        ]);
    }
     ...
     */
    public static function execute($componentid) {
        ...
        $data = tool_courserating_output_fragment_course_ratings_popup(['componentid' => $componentid]);
