...
class deleterating extends dynamic_form {
    ...
    protected function get_context_for_dynamic_submission(): context {
        $context = ($this->get_rating()->get('component') == 'local_courses' ) ? \context_course::instance($this->get_rating()->get('componentid')) : \context_system::instance();
        //return \context_course::instance($this->get_rating()->get('componentid'));
        return $context;
    }
    ...
    protected function check_access_for_dynamic_submission(): void {
        permission::require_can_delete_rating($this->get_rating_id(), $this->get_rating()->get('componentid'));
    }
    ...
    public function process_dynamic_submission() {
        $rv = ['ratingid' => $this->get_rating_id(), 'componentid' => $this->get_rating()->get('componentid'),'componentname' => $this->get_rating()->get('component')];
    ...
    protected function get_page_url_for_dynamic_submission(): moodle_url {
        return new moodle_url('/course/view.php',
            ['id' => $this->get_rating()->get('componentid'), 'deleterating' => $this->get_rating_id()]);
    }
