...
class report311 extends \table_sql {
    ...
    public function __construct(\moodle_url $url) {
        ...
        $componentid = $url->get_param('id');

        $this->context = \context_course::instance($componentid);
        ...
        $fields = $userfields . ',
             ...
             tool_courserating_rating.componentid AS componentid';
        ...
        $where = 'tool_courserating_rating.componentid = :rbparam0';
        $params = ['rbparam0' => $componentid];
    ...
    public function col_fullname($row) {
        ...
        return $OUTPUT->user_picture($row, ['componentid' => $this->context->instanceid, 'includefullname' => true]);
    }
}
