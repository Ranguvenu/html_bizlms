...
$string['local_courses'] = 'Course reviews';
$string['local_learningplan'] = 'Learningplan reviews';
$string['local_program'] = 'Program reviews';
$string['local_classroom'] = 'Classroom reviews';
$string['courselabel'] = 'Course rating';
$string['learningplanlabel'] = 'Learningplan rating';
$string['programlabel'] = 'Program rating';
$string['classroomlabel'] = 'Classroom rating';
