...
$string['dnduploadlabel-mp3'] = 'Add Audio with Video';
$string['dnduploadlabel-mp4'] = 'Add Video with Video';
$string['dnduploadlabeltext'] = 'Add video with Video';
...
$string['videourl_error'] = 'Video URL';
$string['videofile'] = 'Or select an MP3 or MP4 file';
$string['videofile_help'] = 'You can upload an MP3 or MP4 file, host it on MoodleData and show it in the Video player';
$string['pluginadministration'] = 'Videos';
$string['modulename_help'] = 'This module adds a Video within Moodle.';
...
$string['report_filename'] = 'Video Plugin video preview - {$a}';
...
$string['supervideo:addinstance'] = 'Create new activities with Video';
$string['supervideo:view'] = 'View and interact with Video';

$string['privacy:metadata'] = 'The video plugin does not send any personal data to third parties.';
