                ...
                default:
                    if (strpos($filtertype, 'customfield_') === 0) {
                        ...
                        if (!empty($catgeorylike)) {
                            ...
                            $wheresql .= " AND lc.id IN (SELECT lcm.moduleid FROM {local_custom_fields_mapped} AS lcm WHERE lcm.moduletype LIKE 'classroom' AND ($catdependencysql) )";
                        }
                    }
