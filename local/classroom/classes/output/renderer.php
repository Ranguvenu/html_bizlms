...
class renderer extends plugin_renderer_base
{
    ...
    public function get_content_viewclassroom($classroomid)
    {
        ...
        */
        ...
        $display_ratings = $output->course_rating_block_custom($classroomid,$componentname);
        $display_ratingsdefault = $output->course_rating_block($classroomid,$componentname);
