...
if ($groups) {
  ...
  if ($mform->is_cancelled()) {
    ...
    'states'=>$states,'district'=>$district,'subdistrict'=>$subdistrict,'village'=>$village, 'email' => $email, 'groups' => $filtergroup, 'idnumber' => $idnumber, 'uname' => $uname,'designation' => $designation);
