    ...
    public function definition() {
        ...
        if ($form_status == 0) {
            ...
            $mform->addGroup(
                $manageapproval,
                'approvalreqd',
                get_string('need_manage_approval', 'local_learningplan'),
                array('&nbsp;&nbsp;'),
                false
            );
            ...
            $mform->addElement(
                'filepicker',
                'summaryfile',
                get_string('learning_path_summary_file', 'local_learningplan'),
                null,
            ...
            get_custom_fields($costcenterid, $mform, $moduletype = 'learningplan');
            //certificate
