    ...
    public function export_for_template(renderer_base $output) {
        ...
        if (!empty($this->courseslist)) {
            ...
            foreach ($this->courseslist as $inprogress_coursename) {
                ...
                $display_ratings = $output->course_rating_block_custom($inprogress_coursename->id,$componentname);
                $display_ratingsdefault = $output->course_rating_block($inprogress_coursename->id,$componentname);
                // print_r($display_ratings);
                // exit;
                $onerow['ratingavg'] = $display_ratings;
