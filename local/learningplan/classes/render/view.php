...
class view extends plugin_renderer_base {
    ...
    public function single_plan_view($planid) {
        ...
        $componentname = 'local_learningplan';
        $display_ratings = $output->course_rating_block_custom($planid, $componentname);
        $display_ratingsdefault = $output->course_rating_block($planid, $componentname);
        ...
        $planview_context['display_like'] = $display_ratings;
    ...
    public function select_from_users_of_learninplan($planid, $userid, $params, $total = 0, $offset1 = -1, $perpage = -1, $lastitem = 0) {
        ...
        if (!empty($params['designation'])) {
            ...
            $designations = explode(',', $params['designation']);
            list($designationsql, $designationparams) = $this->db->get_in_or_equal($designations, SQL_PARAMS_NAMED, 'designation');
    ...
    public function assigned_learningplans_courses($planid) {
        ...
        if (empty($courses)) {
            ...
            foreach ($courses as $course) {
                ...
                $enddiv = '<div>';
                $course_url = new \moodle_url('/course/view.php', array('id' => $course->id, 'lpid' => $planid));
    ...
    public function learningplaninfo_for_employee($planid) {
        ...
        if ($lplanassignedcourses) {
            ...
            foreach ($lplanassignedcourses as $assignedcourse) {
                ...
                $coursepageurl = new \moodle_url('/course/view.php', array('id' => $assignedcourse->id, 'lpid' => $planid));
