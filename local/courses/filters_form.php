...
class filters_form extends moodleform {
    ...
    function definition() {
        ...
        foreach ($filterlist as $key => $value) {
            if ($value === 'customfields' || $value === 'categories' || $value === 'elearning' || $value === 'status' /*|| $value === 'coursetype'*/) {
                $filter = 'courses';
            } else if ($value === 'email' || $value === 'states' || $value === 'district' || $value === 'subdistrict' || $value === 'village' || $value === 'employeeid' || $value === 'username' || $value === 'users' || $value === 'designation' || $value === 'hrmsrole' || $value === 'project') {
                $filter = 'users';
