...
class lib {
    public function custom_field_operations($formdata) {
        global $DB, $USER;
        $data = new \stdClass();
        ...
        if ($formdata->parentid == 0) {
            ...
            $parent = $querylib->customfield_record(array('id' => $formdata->parentid));
        ...
        if ($formdata->id) {
            ...
            $parentpath = $querylib->customfield_field('path', array('id' => $formdata->parentid));
