...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    ...
    Newcustomcategory.prototype.init = function() {
        ...
        if(this.repositoryid){
            var head = Str.get_string('updatecuscategory', 'local_custom_fields');
        }else{
            var head = Str.get_string('addnewcustom_category', 'local_custom_fields');
        }
        return head.then(function(title) {
            ...
            self.modal.setLarge();
            this.modal.getRoot().addClass('openLMStransition local_custom_fields');
    ...
    Newcustomcategory.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('local_custom_fields', 'new_custom_fields_form', this.contextid, params);
    };
    ...
    Newcustomcategory.prototype.submitFormAjax = function(e) {
        ...
        // Now we can continue...
        Ajax.call([{
            methodname: 'local_custom_fields_submit_custom_fields_form',
    ...
    return /** @alias module:local_costcenter/newcostcenter */ {
                ...
                .done(function(modal) {
                    ...
                    modal.getRoot().find('[data-action="save"]').on('click', function() {
                        ...
                        $.ajax({
                            method: "POST",
                            dataType: "json",
                            url: M.cfg.wwwroot + "/local/custom_fields/ajax.php?action="+args.selector+"&skillid="+args.skillid,
                            success: function(){
        ...
        nodelete: function(args) {
            ...
            if(args.parentcatid){
                var head = Str.get_string('nodeletecatchild', 'local_custom_fields', args);
            }else{
                var head = Str.get_string('nodeletecattop', 'local_custom_fields', args);
            }
            return head.then(function(body) {
                return ModalFactory.create({
                    title: Str.get_string('reason', 'local_custom_fields'),
                    type: ModalFactory.types.DEFAULT,
                    body: body,
                });
