...
function request_filter($mform) {
    ...
    if ((has_capability('local/request:viewrecord', (new \local_request\lib\accesslib())::get_module_context()) || is_siteadmin())) {
...
function local_request_leftmenunode(){
    ...
    } else if (has_capability('local/request:viewrecord', $systemcontext)) {
