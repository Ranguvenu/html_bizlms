...
if (has_capability('local/request:viewrecord', $systemcontext) || is_siteadmin()) {
    ...
    if ((!$component && !$courseid) || in_array($component, $componentarray)) {
        ...
        echo '<a class="btn-link btn-sm" href="javascript:void(0);"
        data-toggle="collapse"data-target="#local_request-filter_collapse"
        aria-expanded="false" aria-controls="local_request-filter_collapse"
        title="'.get_string('filters', 'local_request').'"><i class="m-0 fa fa-sliders fa-2x" aria-hidden="true"></i></a>';
