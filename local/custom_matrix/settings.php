...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_custom_matrix/performance_matrix_status',
        new lang_string('enable'),
        new lang_string('enable_desc', 'local_custom_matrix'),
        0
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'local_custom_matrix/performance_matrix_role_type',
        $name,
        $description,
    ...
    $setting = new admin_setting_configselect(
        'local_custom_matrix/performance_period_type',
        $period_name,
        $period_description,
