    ...
    public function definition() {
        ...
        if ($form_status == 0) {
            ...
            if ($plugin_exists) {
                ...
                $mform->addElement('select', 'open_categoryid', get_string('open_categoryid', 'local_learningplan'), $performance_types);
            ...
            $mform->addElement(
                'filepicker',
                'programlogo',
                get_string('programlogo', 'local_program'),
                null,
            ...
            $mform->addElement(
                'editor',
                'cr_description',
                get_string('description', 'local_program'),
                null,
                $editoroptions
            );
            ...
            get_custom_fields($costcenterid, $mform, $moduletype = 'program');
            ...
            if (function_exists($functionname)) {
                ...
                $functionname($mform, array('group', 'designation'), $org);
            }
        ...
        if ($components->form_status == 1) {
            ...
            if ($parentid) {
                ...
                foreach ($parentid as $categoryid) {
                    ...
                    $childcategories = $DB->get_field('local_custom_fields_mapped', 'category', array('parentid' => $categoryid->id, 'moduletype' => 'program', 'moduleid' => $data->id));
