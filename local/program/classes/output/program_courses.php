    ...
    public function export_for_template(renderer_base $output) {
        ...
        if (!empty($this->courseslist)) {
            ...
            foreach ($this->courseslist as $inprogress_bootcamps) {
                ...
                $display_ratings = $output->course_rating_block_custom($inprogress_bootcamps->id,$componentname);
                $display_ratingsdefault = $output->course_rating_block($inprogress_bootcamps->id,$componentname);
                $onerow['rating_element'] = $display_ratings;
