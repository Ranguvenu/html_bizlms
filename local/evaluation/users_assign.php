...
if ($evaluationid) {
    ...
    if (!empty($pluginexists)) {
        ...
        $options = array('context' => $context->id, 'evaluationid' => $evaluationid, 'organization' => $organization, 'department' => $department, 'subdepartment' => $subdepartment, 'department4level' => $department4level, 'email' => $email, 'idnumber' => $idnumber, 'uname' => $uname, 'groups' => $groups, 'location' => $location,  'designation' => $designation, 'hrmsrole' => $hrmsrole);
