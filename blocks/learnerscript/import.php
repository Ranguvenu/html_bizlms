...
$lsimportlogs = $DB->get_fieldset_sql($lsimportlogssql, array(
    'action' => 'import',
    'target' => 'report',
    'objecttable' => 'block_learnerscript',
    'other' => 'N;'
));
$lastreport = 0; */
$lastreport = 0;
...
if ($importstatus && !$lsreportconfigstatus) {
    $pluginsettings = new block_learnerscript_licence_setting(
        'block_learnerscript/lsreportconfigimport',
        'lsreportconfigimport',
        get_string('lsreportconfigimport', 'block_learnerscript'),
        '',
        PARAM_INT,
        2
    );
...
if ($importstatus && !$lsreportconfigstatus) {
    $PAGE->requires->js_call_amd(
        'block_learnerscript/lsreportconfig',
        'init',
        array(
            array(
                'total' => $total,
