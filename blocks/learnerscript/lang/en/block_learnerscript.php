...
$string['report_classroom'] = 'Classrooms';
$string['report_classroom_help'] = 'Classroom summary';
$string['classroomcolumns'] = 'Classroom column';
...
$string['report_classroomusers_help'] = '<p><strong>Description:</strong>Classroom Users report displays the count of enrolled classrooms and sessions attended. </p>';
...
$string['report_classroomsessionattendence_help'] = '<p><strong>Description:</strong>Classroom Session Attendance report displays the Classroom Session wise user attendance details. </p>';
...
$string['report_traininghoursvsusers_help'] = '<p><strong>Description:</strong>Classroom trainings and users covered overview report</p>';
$string['report_trainerslist_help'] = '<p><strong>Description:</strong>Trainers overview report</p>';
$string['report_trainermanhours_help'] = '<p><strong>Description:</strong>Trainer Man Hours report</p>';
$string['report_orgclassrooms_help'] = '<p><strong>Description:</strong>Organisation wise Classrooms overview report</p>';
$string['report_trainingsoverview_help'] = '<p><strong>Description:</strong>Classrooms wise trainings/sessions overview report</p>';
$string['report_trainingsprogress_help'] = '<p><strong>Description:</strong>Classrooms scheduled by month/year report.</p>';
$string['report_userparticipation_help'] = '<p><strong>Description:</strong>Displays user wise participation count for all modules.</p>';
$string['report_orgwiseskillachieved_help'] = '<p><strong>Description:</strong>Displays Organisation wise skills acheived users count</p>';
$string['mycoursescolumn'] = 'My Courses';
$string['report_statscoursesoverview'] = 'Courses Overview Stats Report';
$string['report_statslearningplansoverview'] = 'LearningPaths Overview Stats Report';
$string['report_statsclassroomsoverview'] = 'Classrooms Overview Stats Report';
$string['select_course'] = 'Select Course';
$string['select_user'] = 'Select User';
$string['select_program'] = 'Select Program';
$string['select_learningpath'] = 'Select Learning Path';
$string['select_classroom'] = 'Select Classroom';
$string['report_statsclassroomoverview'] = 'Classrooms Overview Stats Report';
$string['report_statsorgoverview'] = 'Organisation Overview Stats Report';
