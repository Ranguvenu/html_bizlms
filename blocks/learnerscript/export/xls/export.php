    ...
    foreach($filters  as $key=>$value){
            switch($key){
               case 'filter_organization':
                 ...
                 $departments = array();
                 $departments[] = get_string('open_department','local_costcenter');
                 ...
                 $subdepartments[] = get_string('open_subdepartment','local_costcenter');
                 ...
                 $level4departments[] = get_string('open_level4department','local_costcenter');
                 ...
                 $level5departments[] = get_string('subsubsubdepartment','local_costcenter');
                 ...
                 $onlinetest = $DB->get_field('course','fullname as name',array('id'=>$value));
