...
class block_performance_matrix_renderer extends plugin_renderer_base {
    public function render_performancefilters() {
        ...
        $renderedtemplate = $this->render_from_template('block_performance_matrix/performancematrix', ['userid' => $USER->id, 'performancetypes' => ($performancetypes), 'enable_quarter' => $enable_quarter, 'is_admin' => is_siteadmin(), 'enable_halfyear' => $enable_halfyear]);
