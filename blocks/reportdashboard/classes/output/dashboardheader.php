...
class dashboardheader implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if (is_siteadmin() || has_capability('block/learnerscript:managereports', $categorycontext)) {
        ...
        $categorycontext = (new \local_users\lib\accesslib())::get_module_context();
        $data['issiteadmin'] = (is_siteadmin() || has_capability('block/learnerscript:managereports',$categorycontext)) ? true : false;
