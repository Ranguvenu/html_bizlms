...
2. SCSS:
  a. Replace the files in this folder (/theme/epsilon/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/epsilon/scss/fontawesome.
  c. Update theme/epsilon/thirdpartylibs.xml.
