 ...
 *
 * @module     theme_epsilon_classic/form-display-errors
...
define(['jquery', 'core_form/events'], function($, FormEvent) {
    return {
        ...
        enhance: function(elementid) {
            ...
            if (form && !('epsilon_classicFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.epsilon_classicFormErrorsEnhanced = 1;
            }
        }
    };
});
