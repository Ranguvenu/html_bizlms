 ...
 *
 * @module     theme_epsilon_classic/drawers
 ...
 * {@link module:theme_epsilon_classic/drawers#eventTypes eventTypes} object.
 *
 * @example <caption>Standard usage</caption>
 *
 * // The module just needs to be included to add drawer support.
 * import 'theme_epsilon_classic/drawers';
 *
 * @example <caption>Manually open or close any drawer</caption>
 *
 * import Drawers from 'theme_epsilon_classic/drawers';
 *
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_epsilon_classic/drawers:show}
     * @property {String} drawerShown See {@link event:theme_epsilon_classic/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_epsilon_classic/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_epsilon_classic/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_epsilon_classic/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_epsilon_classic/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_epsilon_classic/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_epsilon_classic/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_epsilon_classic/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_epsilon_classic/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_epsilon_classic/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_epsilon_classic/drawers:hidden',
    };
     ...
     * @returns {module:theme_epsilon_classic/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_epsilon_classic/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_epsilon_classic/drawers:close');
     ...
     *
     * @param {module:theme_epsilon_classic/drawers} comparisonInstance
     */
