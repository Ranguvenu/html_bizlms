...
* remove folder theme/epsilon_classic/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/epsilon_classic/scss/bootstrap
...
* comment out this line in theme/epsilon_classic/scss/_print.scss
    @page {
...
* remove folder theme/epsilon_classic/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/epsilon_classic/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/epsilon_classic/amd/src
* edit theme/epsilon_classic/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/epsilon_classic run "grunt amd" to compile the bootstrap JS
* in folder theme/epsilon_classic run "grunt css" to compile scss
