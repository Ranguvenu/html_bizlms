...
namespace theme_epsilon_classic;
...
/**
 * Creates a navbar for epsilon_classic that allows easy control of the navbar items.
 *
 * @package    theme_epsilon_classic
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class epsilon_classicnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_epsilon_classic();
    }

    /**
     * Prepares the navigation nodes for use with epsilon_classic.
     */
    protected function prepare_nodes_for_epsilon_classic(): void {
        global $PAGE;
    ...
    /**
     * Get all the epsilon_classicnavbaritem elements.
     *
     * @return epsilon_classicnavbaritem[] Epsilon_classic navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this epsilon_classic navbar
     */
    ...
    /**
     * Remove a epsilon_classicnavbaritem from the epsilon_classic navbar.
     *
     * @param  string|int $itemkey An identifier for the epsilon_classicnavbaritem
     * @param  int|null $itemtype An additional type identifier for the epsilon_classicnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the epsilon_classicnavbaritem.
     */
