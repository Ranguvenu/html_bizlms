...
/**
 * Privacy Subsystem implementation for theme_epsilon_classic.
 *
...
namespace theme_epsilon_classic\privacy;
...
/**
 * The epsilon_classic theme stores a user preference data.
 *
 * @copyright  2018 Andrew Nicols <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_epsilon_classic');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_epsilon_classic');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_epsilon_classic',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_epsilon_classic');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_epsilon_classic');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_epsilon_classic',
