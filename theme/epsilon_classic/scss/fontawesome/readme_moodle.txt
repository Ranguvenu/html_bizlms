...
2. SCSS:
  a. Replace the files in this folder (/theme/epsilon_classic/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/epsilon_classic/scss/fontawesome.
  c. Update theme/epsilon_classic/thirdpartylibs.xml.
