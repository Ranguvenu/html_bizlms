...
$string['choosereadme'] = 'Epsilon_classic is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'Epsilon_classic';
...
$string['colorsettings'] = 'Color settings';
$string['pluginname'] = 'Epsilon_classic';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href="#">Epsilon_classic presets</a> for information on creating and sharing your own preset files, and see the <a href="#">Presets repository</a> for presets that others have shared.';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['privacy:metadata'] = 'The Epsilon_classic theme does not store any personal data about any user.';
...
$string['region-right_content'] = 'Layer right content';
$string['region-left_content'] = 'Layer left content';
...
$string['quicknavigationview'] = 'Quick Navigation View'; 
$string['quicknavigationview_desc'] = 'Quick Navigation block ui view is blocks or cards';
